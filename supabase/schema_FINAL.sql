...
-- Policies: drop-and-recreate is safe because tables are freshly created above
-- If running on an existing DB, existing policies are dropped first then recreated.

DROP POLICY IF EXISTS "public_read_states" ON states;
DROP POLICY IF EXISTS "service_write_states" ON states;
DROP POLICY IF EXISTS "public_read_districts" ON districts;
DROP POLICY IF EXISTS "service_write_districts" ON districts;
DROP POLICY IF EXISTS "public_read_assembly_constituencies" ON assembly_constituencies;
DROP POLICY IF EXISTS "service_write_assembly_constituencies" ON assembly_constituencies;
DROP POLICY IF EXISTS "public_read_mandals" ON mandals;
DROP POLICY IF EXISTS "service_write_mandals" ON mandals;
DROP POLICY IF EXISTS "public_read_representatives" ON representatives;
DROP POLICY IF EXISTS "service_write_representatives" ON representatives;
DROP POLICY IF EXISTS "public_read_ministries" ON ministries;
DROP POLICY IF EXISTS "service_write_ministries" ON ministries;
DROP POLICY IF EXISTS "public_read_tenure_records" ON tenure_records;
DROP POLICY IF EXISTS "service_write_tenure_records" ON tenure_records;
DROP POLICY IF EXISTS "public_read_mla_performance" ON mla_performance;
DROP POLICY IF EXISTS "service_write_mla_performance" ON mla_performance;
DROP POLICY IF EXISTS "public_read_election_cycles" ON election_cycles;
DROP POLICY IF EXISTS "service_write_election_cycles" ON election_cycles;
DROP POLICY IF EXISTS "public_read_election_results" ON election_results;
DROP POLICY IF EXISTS "service_write_election_results" ON election_results;
DROP POLICY IF EXISTS "public_read_candidate_profiles" ON candidate_profiles;
DROP POLICY IF EXISTS "service_write_candidate_profiles" ON candidate_profiles;
DROP POLICY IF EXISTS "public_read_party_performance" ON party_performance;
DROP POLICY IF EXISTS "service_write_party_performance" ON party_performance;
DROP POLICY IF EXISTS "public_read_constituency_demographics" ON constituency_demographics;
DROP POLICY IF EXISTS "service_write_constituency_demographics" ON constituency_demographics;
DROP POLICY IF EXISTS "public_read_voter_turnout_history" ON voter_turnout_history;
DROP POLICY IF EXISTS "service_write_voter_turnout_history" ON voter_turnout_history;
DROP POLICY IF EXISTS "public_read_ndap_datasets" ON ndap_datasets;
DROP POLICY IF EXISTS "service_write_ndap_datasets" ON ndap_datasets;
DROP POLICY IF EXISTS "public_read_ground_truth_facts" ON ground_truth_facts;
DROP POLICY IF EXISTS "service_write_ground_truth_facts" ON ground_truth_facts;
DROP POLICY IF EXISTS "public_read_ai_insight_cache" ON ai_insight_cache;
DROP POLICY IF EXISTS "service_write_ai_insight_cache" ON ai_insight_cache;
DROP POLICY IF EXISTS "public_read_ai_validation_log" ON ai_validation_log;
DROP POLICY IF EXISTS "service_write_ai_validation_log" ON ai_validation_log;
DROP POLICY IF EXISTS "public_read_fact_refresh_log" ON fact_refresh_log;
DROP POLICY IF EXISTS "service_write_fact_refresh_log" ON fact_refresh_log;
DROP POLICY IF EXISTS "public_read_data_sync_log" ON data_sync_log;
DROP POLICY IF EXISTS "service_write_data_sync_log" ON data_sync_log;
DROP POLICY IF EXISTS "public_read_pipeline_locks" ON pipeline_locks;
DROP POLICY IF EXISTS "service_write_pipeline_locks" ON pipeline_locks;
DROP POLICY IF EXISTS "public_read_politician_profiles" ON politician_profiles;
DROP POLICY IF EXISTS "service_write_politician_profiles" ON politician_profiles;
DROP POLICY IF EXISTS "public_read_epics" ON epics;
DROP POLICY IF EXISTS "service_write_epics" ON epics;
DROP POLICY IF EXISTS "public_read_epic_episodes" ON epic_episodes;
DROP POLICY IF EXISTS "service_write_epic_episodes" ON epic_episodes;
DROP POLICY IF EXISTS "public_read_user_epic_progress" ON user_epic_progress;
DROP POLICY IF EXISTS "service_write_user_epic_progress" ON user_epic_progress;
...
CREATE POLICY "public_read_assembly_constituencies" ON assembly_constituencies FOR SELECT USING (true);
CREATE POLICY "public_read_mandals" ON mandals FOR SELECT USING (true);
CREATE POLICY "public_read_representatives" ON representatives FOR SELECT USING (true);
CREATE POLICY "public_read_ministries" ON ministries FOR SELECT USING (true);
CREATE POLICY "public_read_tenure_records" ON tenure_records FOR SELECT USING (true);
CREATE POLICY "public_read_mla_performance" ON mla_performance FOR SELECT USING (true);
CREATE POLICY "public_read_election_cycles" ON election_cycles FOR SELECT USING (true);
CREATE POLICY "public_read_election_results" ON election_results FOR SELECT USING (true);
CREATE POLICY "public_read_candidate_profiles" ON candidate_profiles FOR SELECT USING (true);
CREATE POLICY "public_read_party_performance" ON party_performance FOR SELECT USING (true);
CREATE POLICY "public_read_constituency_demographics" ON constituency_demographics FOR SELECT USING (true);
CREATE POLICY "public_read_voter_turnout_history" ON voter_turnout_history FOR SELECT USING (true);
CREATE POLICY "public_read_ndap_datasets" ON ndap_datasets FOR SELECT USING (true);
CREATE POLICY "public_read_ground_truth_facts" ON ground_truth_facts FOR SELECT USING (true);
CREATE POLICY "public_read_ai_insight_cache" ON ai_insight_cache FOR SELECT USING (true);
CREATE POLICY "public_read_ai_validation_log" ON ai_validation_log FOR SELECT USING (true);
CREATE POLICY "public_read_fact_refresh_log" ON fact_refresh_log FOR SELECT USING (true);
CREATE POLICY "public_read_data_sync_log" ON data_sync_log FOR SELECT USING (true);
CREATE POLICY "public_read_pipeline_locks" ON pipeline_locks FOR SELECT USING (true);
CREATE POLICY "public_read_politician_profiles" ON politician_profiles FOR SELECT USING (true);
CREATE POLICY "public_read_epics" ON epics FOR SELECT USING (true);
CREATE POLICY "public_read_epic_episodes" ON epic_episodes FOR SELECT USING (true);
CREATE POLICY "public_read_user_epic_progress" ON user_epic_progress FOR SELECT USING (true);

-- Service role write (backend API with service key can write everything)
CREATE POLICY "service_write_states" ON states FOR ALL USING (true);
CREATE POLICY "service_write_districts" ON districts FOR ALL USING (true);
CREATE POLICY "service_write_assembly_constituencies" ON assembly_constituencies FOR ALL USING (true);
CREATE POLICY "service_write_mandals" ON mandals FOR ALL USING (true);
CREATE POLICY "service_write_representatives" ON representatives FOR ALL USING (true);
CREATE POLICY "service_write_ministries" ON ministries FOR ALL USING (true);
CREATE POLICY "service_write_tenure_records" ON tenure_records FOR ALL USING (true);
CREATE POLICY "service_write_mla_performance" ON mla_performance FOR ALL USING (true);
CREATE POLICY "service_write_election_cycles" ON election_cycles FOR ALL USING (true);
CREATE POLICY "service_write_election_results" ON election_results FOR ALL USING (true);
CREATE POLICY "service_write_candidate_profiles" ON candidate_profiles FOR ALL USING (true);
CREATE POLICY "service_write_party_performance" ON party_performance FOR ALL USING (true);
CREATE POLICY "service_write_constituency_demographics" ON constituency_demographics FOR ALL USING (true);
CREATE POLICY "service_write_voter_turnout_history" ON voter_turnout_history FOR ALL USING (true);
CREATE POLICY "service_write_ndap_datasets" ON ndap_datasets FOR ALL USING (true);
CREATE POLICY "service_write_ground_truth_facts" ON ground_truth_facts FOR ALL USING (true);
CREATE POLICY "service_write_ai_insight_cache" ON ai_insight_cache FOR ALL USING (true);
CREATE POLICY "service_write_ai_validation_log" ON ai_validation_log FOR ALL USING (true);
CREATE POLICY "service_write_fact_refresh_log" ON fact_refresh_log FOR ALL USING (true);
CREATE POLICY "service_write_data_sync_log" ON data_sync_log FOR ALL USING (true);
CREATE POLICY "service_write_pipeline_locks" ON pipeline_locks FOR ALL USING (true);
CREATE POLICY "service_write_politician_profiles" ON politician_profiles FOR ALL USING (true);
CREATE POLICY "service_write_epics" ON epics FOR ALL USING (true);
CREATE POLICY "service_write_epic_episodes" ON epic_episodes FOR ALL USING (true);
CREATE POLICY "service_write_user_epic_progress" ON user_epic_progress FOR ALL USING (true);
